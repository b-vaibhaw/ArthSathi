# patch_main.py - safe patching of api/main.py with smart responder using ASCII escapes
import sys
...
def main():
    ...
    # Let's locate generate_response and replace it up to the start of WHATSAPP WEBHOOK
    start_marker = "async def generate_response"
    end_marker = "# \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n# 7. WHATSAPP WEBHOOK"
    
    idx_start = content.find(start_marker)
    if idx_start == -1:
        print("Error: Could not find start of generate_response")
        sys.exit(1)
        
    idx_end = content.find(end_marker)
    if idx_end == -1:
        # try without line break
        end_marker_alt = "# 7. WHATSAPP WEBHOOK"
        idx_end = content.find(end_marker_alt)
        if idx_end == -1:
            print("Error: Could not find end marker (WHATSAPP WEBHOOK)")
            sys.exit(1)
        else:
            # backtrack to the line above
            idx_end = content.rfind("#", 0, idx_end)
            
    # New code definition with unicode escapes
    new_code = r"""def _generate_smart_response(user_message: str, user_id: str, language: str,
                             intent: Optional[str], engine_result: Optional[Dict],
                             rag_docs: List[Dict]) -> Optional[str]:
    """
    new_code += '"""' + "\n"
    new_code += r"""    Generate accurate structured financial answers in English, Hindi, or Marathi
    based on engine calculations and RAG facts.
    """
    new_code += '"""' + "\n"
    new_code += r"""    msg_lower = user_message.lower()
    ...
    if intent == "pricing_query":
        ...
        if nums:
            ...
            if language == "hi":
                ...
                return "\u0915\u0943\u092a\u092f\u093e \u0924\u094c\u092e\u091a\u094d\u092f\u093e \u090\u0924\u094d\u092a\u093e\u0926\u0928\u093e\u091a\u0940 \u0916\u0930\u094d\u0947\u0926\u0940 \u0915\u093f\u0902\u092e\u0924 \u0938\u093e\u0902\u0917\u093e, \u092e\u0940 \u0935\u093f\u0915\u094d\u0930\u0940 \u0915\u093f\u0902\u092e\u0924 \u0920\u0930\u0935\u0942\u0928 \u0926\u094d\u0947\u0908\u0928."
            else:
    ...
    if intent == "tax_query" or "gst" in msg_lower or "turnover" in msg_lower or "tax" in msg_lower:
        ...
        if language == "hi":
            ...
            return ("\u0906\u092f\u0915\u0930 \u0906\u0923\u093f \u0906\u092f\u091f\u094d\u0940\u0906\u0930 \u092e\u093e\u0939\u093f\u0924\u0940:\n\n"
                    ...
                    "\u2022 \u0932\u0918\u0942 \u0935\u094d\u092f\u093e\u092a\u093e\u0930\u094d\u094d\u092f\u093e\u0902\u0938\u093e\u0920\u0940 **ITR-4** \u0938\u0930\u094d\u0935\u094b\u092current \u092e\u093e\u0930\u094d\u0917 \u0906\u0939\u094d\u092f\u0947. \u0924\u094c\u092e\u094d\u093\u0940 \u0916\u093e\u0924\u0940 \u0928 \u0920\u094d\u0947\u093check\u0924\u093e \u0924\u094c\u092e\u091a\u094d\u092f\u093e \u090f\u0915\u0942\u0923 \u090a\u0932\u093e\u0922\u093e\u0932\u094d\u0940\u091a\u094d\u092f\u093e \u092b\u0915\u094d\u0924 \u096e% (\u0921\u093f\u091c\u093f\u091f\u0932 \u0935\u094d\u092f\u0935\u0939\u093e\u0930\u093e\u0902\u0935\u0930 \u096a%) \u090a\u0925\u094d\u092a\u0928\u094d\u0928 \u0926\u093e\u0916\u0935\u0942 \u0936\u0915\u0924\u093e.\n\n"
    ...
    if rag_docs:
        ...
        if language == "hi":
            ...
            return (f"\u0928\u092e\u0938\u094d\u0915\u093e\u0930! \u092e\u0932\u093e \u0924\u094c\u092e\u094d\u093hash\u094d\u092f\u093e \u092e\u093e\u0930\u094d\u0917\u0926\u0930\u094d\u0936\u0928\u093e\u0938\u093e\u0920\u0940 \u092f\u0947\u0925\u094d\u0947 \u0906\u0928\u0902\u0926 \u0906\u0939\u094d\u092f\u0947. \u0906\u092e\u091a\u094d\u092f\u093e \u092e\u093e\u0939\u093f\u0924\u0940\u0928\u094c\u0938\u093e\u0930:\n\n"
                    f"{best_doc}\n\n"
...
async def generate_response(user_message: str, user_id: str,
    ...
    system_prompts = {
        ...
        "mr":  "\u0924\u094c\u092e\u094d\u093hash\u094d\u092f\u093e \u092e\u093e\u0930\u094d\u0917\u0926\u0930\u094d\u0936\u0928\u093e\u0938\u093e\u0920\u0940 ArthaSathi.",
    }
...
"""
    ...
    patched_content = content[:idx_start] + new_code + content[idx_end:]
    
    # Also fix unicode prints
    ...
    main_path.write_text(patched_content, encoding="utf-8")
    print("api/main.py patched successfully!")
